...
function getLocationType(name: string): LocationType {
  ...
  if (lowerName.includes('clothing') || lowerName.includes('binco') || 
      lowerName.includes('suburban') || lowerName.includes('fashion') || 
      lowerName.includes('thrift') || lowerName.includes('flip flops')) return 'clothing';
  if (lowerName.includes('bank') || lowerName.includes('flecca') || 
      lowerName.includes('lombank') || lowerName.includes('savings')) return 'bank';
  if (lowerName.includes('ammunation') || lowerName.includes('armory') || 
      lowerName.includes('munitions')) return 'ammunation';
  if (lowerName.includes('phone') || lowerName.includes('telecommunications') || 
      lowerName.includes('digital den') || lowerName.includes('vision electronics') ||
      lowerName.includes('cellphones')) return 'phone';
...
['2733', 'Strawberry Gas Station', '360 degree camera', '1', '-1261.2361', '264.72784'],
