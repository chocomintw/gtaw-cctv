...
function getLocationType(name: string): LocationType {
  ...
  if (lowerName.includes("gas station")) return "gas";
  if (
    lowerName.includes("clothing") ||
    lowerName.includes("binco") ||
    lowerName.includes("suburban") ||
    lowerName.includes("fashion") ||
    lowerName.includes("thrift") ||
    lowerName.includes("flip flops")
  )
    return "clothing";
  if (
    lowerName.includes("bank") ||
    lowerName.includes("flecca") ||
    lowerName.includes("lombank") ||
    lowerName.includes("savings")
  )
    return "bank";
  if (
    lowerName.includes("ammunation") ||
    lowerName.includes("armory") ||
    lowerName.includes("munitions")
  )
    return "ammunation";
  if (
    lowerName.includes("phone") ||
    lowerName.includes("telecommunications") ||
    lowerName.includes("digital den") ||
    lowerName.includes("vision electronics") ||
    lowerName.includes("cellphones")
  )
    return "phone";
...
// Convert raw data to CCTVLocation objects
export function convertRawLocations(rawData: string[][]): CCTVLocation[] {
  return rawData.map((item) => ({
    id: item[0], // '2724'
    name: item[1], // 'Palomino Freeway Gas Station / 24/7'
    description: item[2] || "", // 'located inside the LTD'
    coordinates: [
      parseFloat(item[4]), // '381.1359' → 381.1359
      parseFloat(item[5]), // '2552.3525' → 2552.3525
    ],
    type: getLocationType(item[1]),
    enabled: true,
  }));
}

export const rawCCTVData = [
  [
    "2724",
    "Palomino Freeway Gas Station / 24/7",
    "located inside the LTD",
    "1",
    "381.1359",
    "2552.3525",
  ],
  ...
  [
    "2730",
    "Great Ocean Highway Gas Station - Paleto Bay",
    "360 degree camera",
    "1",
    "6603.2754",
    "179.58167",
  ...
  [
    "2753",
    "Senora Freeway North Gas Station",
    "360 degree camera",
    "1",
    "6420.63",
    "1704.9832",
  ...
  [
    "2739",
    "La Puerta Marina Boat Gas Station",
    "",
    "1",
    "-1321.494",
    "-881.25397",
  ...
  [
    "2773",
    "Vespucci Canals Clothing Store",
    "",
    "1",
    "-1075.206",
    "-823.49445",
  ...
  [
    "2774",
    "Prosperity Street Promenade Clothing Store",
    "",
    "1",
    "-776.3548",
    "-1207.4557",
  ...
  [
    "2780",
    "Grand Senora Desert Clothing Store",
    "",
    "1",
    "2702.4143",
    "1194.9103",
  ...
  [
    "2792",
    "Grapeseed Discount Clothing/cctvtp 2791",
    "",
    "1",
    "4828.2163",
    "1685.2671",
  ...
  [
    "2795",
    "Sandy Shores Discount Clothing",
    "Located inside (Press Y)",
    "1",
    "3609.4668",
    "1420.5222",
  ...
  [
    "2872",
    "Rockford Plaza Mall Main Entrance",
    "",
    "1",
    "-286.05457",
    "-151.04855",
  ...
  [
    "2873",
    "Rockford Plaza Mall Rear Entrance",
    "",
    "1",
    "-88.184044",
    "-208.24202",
  ...
  [
    "2425",
    "Pillbox Medical Lower Entrance",
    "",
    "1",
    "-591.54474",
    "363.85434",
  ...
  [
    "2906",
    "Bayview Lodge General Store 24/7",
    "Located inside. Press Y",
    "1",
    "5837.1846",
    "-676.88995",
  ...
  [
    "2971",
    "San Andreas Ave, Vespucci Liquor",
    " (Located inside. Press Y)",
    "1",
    "-906.47266",
    "-1223.8115",
